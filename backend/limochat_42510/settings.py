"""
Django settings for limochat_42510 project.
...
ROOT_URLCONF = 'limochat_42510.urls'
...
WSGI_APPLICATION = 'limochat_42510.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "limochat_42510 API",
    "DESCRIPTION": "API documentation for limochat_42510 App",
    "VERSION": "v1",
}
